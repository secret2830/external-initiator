...
func (pseudoSM2) Address() crypto.Address {
	return nil
}

func (pseudoSM2) Bytes() []byte {
	return nil
}

func (pseudoSM2) VerifySignature(msg []byte, sig []byte) bool {
	return true
}

func (pseudoSM2) Equals(other crypto.PubKey) bool {
	return false
}

func (pseudoSM2) Type() string {
	return ""
}

func init() {
	tmjson.RegisterType(pseudoSM2{}, "tendermint/PubKeySm2")
}
